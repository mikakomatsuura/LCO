...
https://ccdproc.readthedocs.io/en/latest/image_combination.html#image-masks-and-clipping
@author: mikako
"""
...
dir = '/Users/mikako/work/teaching/2025_ObsTech/LCO/data/NGC3201/NGC3201_B_2025/'

file_names = glob.glob(dir+'coj*e91.fits.fz')
...
# select good images, only, if needed
...
for i in range(len(selected_indices)):
    index  = selected_indices[i]
    hdu_list[i] = fits.open(file_names[index])[1]
